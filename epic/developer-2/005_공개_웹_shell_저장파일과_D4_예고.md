...
- [x] Chromium FHD/720 마우스·키보드 E2E가 통과한다. branded Edge 실행은 브라우저가 있는 공개 QA 환경으로 이관한다.
...
- 남은 위험:
  ...
  - 2026-08-10 결과 중심 판정에 따라 위 두 항목은 웹 shell 기능 미구현이 아닌 공개 QA·배포 환경 검증으로 이관하고 이 태스크를 `완료`로 닫는다.
